...
This repository contains a simple Java program that demonstrates basic Java concepts.
...
This simple Java program demonstrates:
- Basic `System.out.println()` statements
